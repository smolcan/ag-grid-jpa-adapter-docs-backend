...
import io.github.smolcan.ag_grid_jpa_adapter_docs_backend.service.docs.QuickFilterService;
...
@RestController()
@RequestMapping("/docs/filtering/quick-filter")
...
public class QuickFilterController {
    ...
    public ResponseEntity<LoadSuccessParams> getRows(@RequestBody ServerSideGetRowsRequest request) {
        LoadSuccessParams result = this.quickFilterService.getRows(request);
